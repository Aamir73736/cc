...
import os
token = '7547693546:AAFRYrOu8wpg9YkBaPpQPPfOTefM1InUfxg:' #bottoken
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '6965153309'
allowed_users = ['6965153309']  #Your ID
@bot.message_handler(commands=["start"])
def start(message):
    if str(message.chat.id) not in allowed_users:
        bot.reply_to(message, "🚫 𝐘𝐨𝐮 𝐜𝐚𝐧𝐧𝐨𝐭 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐛𝐨𝐭 𝐭𝐨 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐭𝐨 𝐩𝐮𝐫𝐜𝐡𝐚𝐬𝐞 𝐚 𝐛𝐨𝐭 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧 @lllIIIlIlIllIlllIIIlIlIllI")
        return
...
𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: @CHITNGE54 
𝐁𝐲: @lllIIIlIlIllIlllIIIlIlIllI ''' #Declined
					live += 1
					bot.reply_to(message, msg)
				else:
					dd += 1
